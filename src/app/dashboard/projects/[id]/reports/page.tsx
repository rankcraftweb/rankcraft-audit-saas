        ...
        <CardContent className="space-y-4">
          {!latestAudit && !latestPageSpeedReport ? (
            <p className="text-sm text-muted-foreground">
              No audit data is available yet. Run a full SEO audit to generate a
              client-ready report.
            </p>
          ) : (
            <>
        ...
        <CardContent>
          {issueCount === 0 ? (
            ...
            <div className="space-y-4">
              ...
              {mediumIssues > 0 && (
                <div className="rounded-lg border p-4">
                  <p className="font-medium">2. Improve metadata and structure</p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    Review page titles, descriptions, canonical tags, and
                    heading structure to improve search visibility and clarity.
                  </p>
                </div>
              )}
